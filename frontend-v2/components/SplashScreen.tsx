...
const LEFT_ICONS: {
  ...
  { src: M, top: "14%", left:  "62px", size:  70, delay: 1.1, dur: 3.9, glow: "#ffaa00", rotate: -10 },
  ...
  { src: J, top: "46%", left: "-10px", size: 105, delay: 2.1, dur: 5.5, glow: "#22aaff", rotate:  -8 },
  { src: M, top: "54%", left:  "48px", size:  85, delay: 1.0, dur: 4.2, glow: "#ffaa00", rotate:  18 },
  { src: M, top: "60%", left:  "76px", size:  72, delay: 1.6, dur: 3.7, glow: "#ffaa00", rotate:  -5 },
  { src: G, top: "68%", left:   "4px", size: 108, delay: 2.8, dur: 5.0, glow: "#aa88ff", rotate: -14 },
  { src: D, top: "78%", left:  "80px", size:  95, delay: 1.9, dur: 4.6, glow: "#cc44ff", rotate:  10 },
  { src: J, top: "89%", left: "-16px", size: 102, delay: 3.2, dur: 5.8, glow: "#22aaff", rotate: -20 },
];
...
const RIGHT_ICONS: {
  ...
  { src: D, top:  "7%", right:  "12px", size:  95, delay: 0.9, dur: 4.4, glow: "#cc44ff", rotate: -12 },
  { src: J, top: "16%", right:  "54px", size: 100, delay: 1.2, dur: 4.8, glow: "#22aaff", rotate:   8 },
  { src: V, top: "27%", right:   "0px", size: 120, delay: 2.0, dur: 6.2, glow: "#ff44cc", rotate:  -4 },
  { src: D, top: "38%", right: "-14px", size:  98, delay: 1.5, dur: 4.5, glow: "#cc44ff", rotate:  14 },
  { src: M, top: "47%", right:  "44px", size:  82, delay: 0.6, dur: 4.0, glow: "#ffaa00", rotate: -16 },
  { src: M, top: "54%", right:  "70px", size:  72, delay: 1.3, dur: 3.8, glow: "#ffaa00", rotate:   6 },
  { src: D, top: "63%", right:  "-8px", size: 100, delay: 2.4, dur: 5.2, glow: "#cc44ff", rotate:  10 },
  { src: G, top: "73%", right:  "58px", size: 108, delay: 1.8, dur: 5.8, glow: "#aa88ff", rotate: -10 },
  { src: J, top: "84%", right:  "10px", size: 100, delay: 3.0, dur: 4.6, glow: "#22aaff", rotate:  18 },
];
      ...
      <main style={{
        ...
        <img
          ...
          style={{
            ...
            height: "auto",
            animation: "bounce-scale-in 1s cubic-bezier(0.34, 1.56, 0.64, 1) both",
            animationDelay: "0.8s",
          }}
        />
